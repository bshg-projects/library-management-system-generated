...
import org.bshg.librarysystem.webservice.storage.rack.RackDto;
...
public class RackRestApi extends AbstractRestApi<
Rack,
RackDto,
RackService,
RackConverter,
...
UpdateRackProcess,
DeleteRackProcess> {
public RackRestApi( RackService service, RackConverter converter, CreateRackProcess createProcess, UpdateRackProcess updateProcess, DeleteRackProcess deleteProcess) {
