...
public class EmployeeRestApi extends AbstractRestApi<Employee,EmployeeDto,EmployeeService,EmployeeConverter> {
public EmployeeRestApi( EmployeeService service, EmployeeConverter converter) {
