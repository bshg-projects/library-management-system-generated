...
public class ReviewRestApi extends AbstractRestApi<Review,ReviewDto,ReviewService,ReviewConverter> {
public ReviewRestApi( ReviewService service, ReviewConverter converter) {
