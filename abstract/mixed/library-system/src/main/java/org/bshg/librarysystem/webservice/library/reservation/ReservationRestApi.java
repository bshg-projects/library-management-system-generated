...
public class ReservationRestApi extends AbstractRestApi<Reservation,ReservationDto,ReservationService,ReservationConverter> {
public ReservationRestApi( ReservationService service, ReservationConverter converter) {
