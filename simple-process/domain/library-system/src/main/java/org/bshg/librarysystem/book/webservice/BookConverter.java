...
import org.bshg.librarysystem.bookgenre.webservice.BookGenreConverter;
...
this.bookGenre = initialisation;
this.employee = initialisation;
this.publisher = initialisation;
this.rack = initialisation;
}
