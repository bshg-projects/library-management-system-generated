...
import org.bshg.librarysystem.librarybranch.webservice.LibraryBranchConverter;
import org.bshg.librarysystem.librarybranch.webservice.LibraryBranchDto;
...
@Autowired private LibraryBranchConverter converter;
@GetMapping("/id/{id}")
