...
import org.bshg.librarysystem.webservice.event.event.EventConverter;
import org.bshg.librarysystem.webservice.event.event.EventDto;
...
@Autowired private EventConverter converter;
@GetMapping("/id/{id}")
