...
import org.bshg.librarysystem.webservice.library.membership.MembershipConverter;
import org.bshg.librarysystem.webservice.library.membership.MembershipDto;
...
@Autowired private MembershipConverter converter;
@GetMapping("/id/{id}")
