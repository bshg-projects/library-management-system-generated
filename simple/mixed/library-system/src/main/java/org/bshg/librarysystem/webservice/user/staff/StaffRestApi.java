...
import org.bshg.librarysystem.webservice.user.staff.StaffConverter;
import org.bshg.librarysystem.webservice.user.staff.StaffDto;
...
@Autowired private StaffConverter converter;
@GetMapping("/id/{id}")
