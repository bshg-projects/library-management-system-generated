...
import org.bshg.librarysystem.webservice.converter.content.BookGenreConverter;
import org.bshg.librarysystem.webservice.dto.content.BookGenreDto;
...
@Autowired private BookGenreConverter converter;
@GetMapping("/id/{id}")
